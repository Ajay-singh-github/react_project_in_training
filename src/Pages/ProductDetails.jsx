...
export default function ProductDetails() {
  ...
  const smallImages = [
    { url: "https://th.bing.com/th/id/OIP.1DRnsBD2M-hvbyq3dfoWOAHaEK?w=305&h=180&c=7&r=0&o=5&pid=1.7" },
    { url: "https://th.bing.com/th/id/OIP.uSYLE0mMQNrJChgh_uFLnAAAAA?rs=1&pid=ImgDetMain" },
    { url: "https://th.bing.com/th/id/OIP.kMU_wHklQB82vpjkLRZFlQHaFP?w=278&h=197&c=7&r=0&o=5&pid=1.7" },
    { url: "https://th.bing.com/th/id/OIP.Yegw4FkBZKUu8SoA2bNB6QHaE5?w=253&h=180&c=7&r=0&o=5&pid=1.7" },
  ];
        ...
        <div className="details-upper-section">
          <div className="details-left-left">
            {smallImages.map((img, index) => (
              <div key={index}>
                <img src={img.url} onMouseEnter={() => setMainImage(img.url)} />
              </div>
            ))}
          </div>
          ...
          <div style={{ height: "200px", width: "100%", marginTop: "10px", display: "flex", justifyContent: "center" }}>
            ...
            <div style={{ width: "50%", height: "150px", margin: "30px", display: "flex", gap: "10px" }}>
              <div className="outer-circle">
                <div className="inner-circle"><p style={{ margin: "15px" }}>4.6</p></div>
              </div>
              <div className="outer-circle">
                <div className="inner-circle"><p style={{ margin: "15px" }}>2.6</p></div>
              </div>
              <div className="outer-circle">
                <div className="inner-circle"><p style={{ margin: "15px" }}>1.0</p></div>
              </div>
              <div className="outer-circle" >
                <div className="inner-circle"><p style={{ margin: "15px" }}>6.1</p></div>
              </div>
            </div>
